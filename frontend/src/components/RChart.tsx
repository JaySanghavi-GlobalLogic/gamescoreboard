...
//   return (
//     <>
//    <div className="flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-6 overflow-y-auto">
//       <GraphComponent type="line" data={data} options={options} height={300}  width={900} />
//       <div className="bg-white rounded-lg p-6 shadow">
//                     <h3 className="font-semibold mb-2">Specifications</h3>
//                     <div className="space-y-1">
//                         <div><span className="font-medium">USL:</span> {stats?.UCL}</div>
//                         <div><span className="font-medium">LSL:</span> {stats.LCL}</div>
//                         <div><span className="font-medium">Mean:</span> {stats?.mean}</div>
//                     </div>
//                     <hr className="my-3" />
//                     <h3 className="font-semibold mb-2">Legend</h3>
//                     <div className="flex items-center space-x-2 text-xs"><span className="w-4 h-1 bg-black inline-block rounded"></span><span>Range</span></div>
...
//                     <div className="flex items-center space-x-2 text-xs"><span className="w-4 h-1 bg-red-600 border-dashed inline-block rounded"></span><span>UCL / LCL</span></div>
//                 </div>
//     </div>
//     </>
//   );
